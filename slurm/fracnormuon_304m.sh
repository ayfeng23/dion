...
#SBATCH --output=logs/fracnormuon_%a.out 
#SBATCH --error=logs/fracnormuon_%a.err
#SBATCH --time=6:00:00
...
sed "s/ortho_fraction:.*/ortho_fraction: $MY_FRACTION/" configs/fracnormuon_304m.yaml > $TMP_CONFIG
